...
final class AbilityDestroyer extends AbilityItem implements AbilityThrowing {
    ...
    public function use(Player $playerVictim, Player $playerDamager): void {
        ...
        $playerDamager->sendMessage("Ability Testing Passed");
    }
